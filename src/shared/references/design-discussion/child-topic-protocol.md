...
`{{resource:guided-implementation/references/thread-settings-protocol.md}}`
...
[split and requirements-gate contract]({{resource:design-discussion/references/split-gate-contract.md}}) before
