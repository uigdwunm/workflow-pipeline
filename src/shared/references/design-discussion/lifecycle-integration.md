...
[the conversation-source contract]({{resource:solution-design/references/conversation-source.md}})
...
[Workflow Control]({{resource:guided-implementation/references/workflow-control-protocol.md}}).
...
[`{{resource:design-discussion/references/confirmation-contract.md}}`]({{resource:design-discussion/references/confirmation-contract.md}}); external authority
...
rules in [{{resource:design-discussion/references/ledger-protocol.md}}]({{resource:design-discussion/references/ledger-protocol.md}}); replay reads the current
