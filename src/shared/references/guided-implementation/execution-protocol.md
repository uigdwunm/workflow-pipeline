...
receipt as specified in [{{resource:guided-implementation/references/workflow-control-protocol.md}}]({{resource:guided-implementation/references/workflow-control-protocol.md}}).
