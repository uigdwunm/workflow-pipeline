...
SCRIPT = Path(__file__).resolve().parents[2] / "skills/guided-implementation/scripts/thread_settings.py"
...
class ThreadSettingsProtocolTests(unittest.TestCase):
    ...
    def test_shared_reference_is_reachable_from_owner_skill(self):
        ...
        self.assertIn("[references/shared/guided-implementation/thread-settings-protocol.md]", owner)
    ...
    def test_dynamic_consumers_use_shared_v4_interface(self):
        consumers = {
            ...
            "skills/problem-framing/references/problem-framing/dedicated-grilling-protocol.md": (
                "resolve --thread-id",
                "verify --thread-id",
            ),
    ...
    def test_dispatch_launch_and_self_check_use_declared_configuration(self):
        ...
        modern = (Path(__file__).resolve().parents[2] / "skills/guided-implementation/references/shared/guided-implementation/workflow-control-protocol.md").exists()
        if modern:
